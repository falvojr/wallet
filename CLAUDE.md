...
- Comentários: `//` em linha única, `/* */` em blocos multilinha. Sentenças terminam com ponto final, respeitando o teto de 160 colunas por linha. Em blocos multilinha, a quebra de linha cai sempre no fim de uma sentença, nunca no meio. Títulos de seção são comentários `//` curtos, sem separadores decorativos de traços.
