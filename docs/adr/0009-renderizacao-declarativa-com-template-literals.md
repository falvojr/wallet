...
Sem framework reativo (ADR [0001](0001-html-css-js-puros-sem-build.md)), a interface precisa de uma forma previsível de refletir o estado sem manipulação imperativa de DOM espalhada pelo código.
...
- Listeners não podem ser anexados ao HTML gerado, pois seriam perdidos no re-render; ver ADR [0010](0010-delegacao-de-eventos-com-data-attributes.md).
